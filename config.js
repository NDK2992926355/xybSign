const config = {
  ...
  accounts: [
    {
      ...
      sign: true, //是否自动签到
      reSign: false, //是否重新签到
      location: "113.950661,22.555513", //经纬度 (可选),例如 "120.210792,30.246026"、"经度,纬度",不填写则自动获取（推荐）
  ...
  qmsgKey: "4bfae7348aba73233506257171c77f05", //qmsg酱key
  qmsgTo: "2992926355", //推送的qq号,用,分隔(可选)
};
